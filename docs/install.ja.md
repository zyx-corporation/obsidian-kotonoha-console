...
**プラグイン:** `obsidian-kotonoha-console` **v0.5.4**\
...
| 項目 | 要件 |
| --- | --- |
| Obsidian | **1.7.2+**（`manifest.json` の `minAppVersion`） |
| 配布形態 | [GitHub Release 0.5.4](https://github.com/zyx-corporation/obsidian-kotonoha-console/releases/tag/0.5.4) |
