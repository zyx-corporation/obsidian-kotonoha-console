...
**Plugin:** `obsidian-kotonoha-console` **v0.5.0**\
...
| --- | --- |
| Obsidian | **1.4.0+** |
| Release | [v0.5.0](https://github.com/zyx-corporation/obsidian-kotonoha-console/releases/tag/v0.5.0) |
...
Download **`obsidian-kotonoha-console-v0.5.0.zip`**, unzip under `.obsidian/plugins/`.
